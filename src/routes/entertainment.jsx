...
const EntertainmentPage = () => {
  // Isseu : Insgtead of using dummy categories, use the caregories from the user data 
  ...
  const fetchMovies = async () => {
    try {
      ...
      const transformedMovies = {
        ...
        // Drama: data.results.filter((movie) => movie.genre_ids.includes(12)),
        // Western: data.results.filter((movie) => movie.genre_ids.includes(16)),
      };
